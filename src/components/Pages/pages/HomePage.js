    ...
    return (
        <div className={'home'}>
            <div className={'aboutUs'}>
                <h2>o nas</h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet excepturi facere iste modi molestias, provident quasi sit sunt temporibus. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet excepturi facere iste modi molestias, provident quasi sit sunt temporibus. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet excepturi facere iste modi molestias, provident quasi sit sunt temporibus. Amet deleniti dolor eum illo incidunt possimus quis quo ratione suscipit.</p>
            </div>
            <div className={'offer'}>
                <h2>Co oferujemy?</h2>
                <ul>
